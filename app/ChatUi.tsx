...
<div className="p-4 sm:ml-64 lg:ml-4">
  <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
    ...
    <div className='lg:ml-[300px] ml-16 m-4'>
      <span className="px-4 py-2 rounded-lg inline-block rounded-bl-none bg-gray-300 text-gray-600">Hello, {greeting}. ask me anything!</span>
    </div>
...
<div className="flex mt-4">
        ...
        <textarea
  className="m-2 p-4 rounded-lg border dark:bg-black dark:text-white w-full sm:w-3/4 lg:w-1/2 max-w-xl"
